...
const logger = require("../catalogs/akashc.js");
...
console.log(`${crayon(``)}${sky(`• AKASH DATA •`)} - bot name : ${chalk.blueBright((!global.config.BOTNAME) ? "Akash" : global.config.BOTNAME)} \n${sky(`• AKASH DATA •`)} - bot id : ${chalk.blueBright(api.getCurrentUserID())} \n${sky(`• AKASH DATA •`)} - bot prefix : ${chalk.blueBright(global.config.PREFIX)}\n${sky(`• AKASH DATA •`)} - deployed ${chalk.blueBright(operator)} bot operators and ${chalk.blueBright(admin)} admins`);
if (global.config.approval) {
  console.log(`${sky(`• AKASH DATA •`)} - deployed ${chalk.blueBright(approved)} approved groups`)
} 
if (global.config.premium) {
  console.log(`${sky(`• AKASH DATA •`)} - deployed ${chalk.blueBright(premium)} premium users`)
}
